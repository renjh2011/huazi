package com.xpand.common.core.page.interceptor;

import com.xpand.common.core.page.Page;
import com.xpand.common.core.page.dialect.Dialect;
import com.xpand.common.core.utils.Reflections;
...
//        String dbName = Global.getConfig("dataBase.type");
        String dbName="mysql";
...
//	        countSql = "select count(1) " + removeSelect(removeOrders(sql));
    ...
    public static String generatePageSql(String sql, Page<Object> page, Dialect dialect) {
        if (dialect.supportsLimit()) {
            return dialect.getLimitString(sql, page.getCurrent(), page.getSize());
        } else {
            return sql;
        }
    }
